    ...
    return (
        <div style={{display: "flex", alignItems: "center"}}>
            <SideBars>
                ...
                <div className="side-bar-text">
                    <div className="side-bar-text-list">
                        <Link className={`side-bar-text ${location.pathname === '/settings' ? 'blue-bg' : ''}`} to="/settings"><a style={{display: "flex", flexDirection: "row", alignItems: "center", gap: '10px'}} className="settings" href=""> <SettingsIcon/> Settings</a></Link>
                    </div>
                </div>
            </SideBars>
