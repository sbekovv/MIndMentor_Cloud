            ...
            <SideBars>
                <div className="side-bar-text">
                    ...
                    <div className="side-bar-text-list">
                        ...
                        <Link className={`side-bar-text ${location.pathname === '/vendors' ? 'blue-bg' : ''}`} to="/vendors"><a style={{display: "flex", flexDirection: "row", alignItems: "center", gap: '10px'}} href="">  <ReactSVG src={Bag} style={{paddingTop: "3px"}}/> Vendors</a></Link>
