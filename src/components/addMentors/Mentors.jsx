        ...
        <div style={{display: "flex", alignItems: "center"}}>
            <SideBars>
                <div className="side-bar-text">
                    ...
                    <div className="side-bar-text-list">
                        ...
                        <Link className={`side-bar-text ${location.pathname === '/mentors' ? 'blue-bg' : ''}`} to="/mentors"><a style={{display: "flex", flexDirection: "row", alignItems: "center", gap: '10px'}} href=""> <ReactSVG src={Account} style={{paddingTop: "3px"}}/> Mentors</a></Link>
            ...
            <Sidebag>
                <div className="side-bar-bag">
                    ...
                    <Box>
                        <h1>Mentors</h1>
                        <Button variant="contained">+ New Mentor</Button>
                    </Box>
                </div>
            </Sidebag>
